---
title: day08-inputformat-outputformat-分组
date: 2019-08-13 21:42:46
tags: hadoop
categories: day08-inputformat-outputformat-分组
---
...
public class MyRecordReader extends RecordReader<NullWritable,BytesWritable>{
    ...
    public boolean nextKeyValue() throws IOException, InterruptedException {
        if(!processed){
            ...
            byte[] bytes = new byte[(int) fileSplit.getLength()];//fileSplit.getLength()获取文档的大小
            IOUtils.readFully(inputStream, bytes, 0, (int)fileSplit.getLength());//readFully()全部读取
            //inputStream.read()也可以使用
...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        //2:设置job任务
            ...
            MyOutputFormat.setOutputPath(job, new Path("file:///D:\\out\\myoutputformat_out"));//此目录存放的是校验文件.success和src文件
...
public class OrderBean  implements WritableComparable<OrderBean>{
    ...
    public int compareTo(OrderBean orderBean) {
        ...
        if(i == 0){
            i = this.price.compareTo(orderBean.price) * -1;//*-1指定降序排序
        }
