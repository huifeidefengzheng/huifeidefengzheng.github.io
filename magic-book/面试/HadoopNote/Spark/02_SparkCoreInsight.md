...
![image](02_SparkCoreInsight/f738dbe3df690bc0ba8f580a3e2d1112-20190905170407892.png)
概述:
...
![image](02_SparkCoreInsight/ec39594f30ca4d59e2ef5cdc60387866.png)
...
![image](02_SparkCoreInsight/05cdb79abd41a7b5baa41a4c62870d73.png)
...
![image](02_SparkCoreInsight/ccd1ae121f6f6852158c044441437f04.png)
...
![image](02_SparkCoreInsight/bb3eda1410d3b0f6e1bff6d5e6a45879.png)
...
![image](02_SparkCoreInsight/23377ac4a368fc94b6f8f3117af67154.png)
...
![image](03_SparkCoreInsight/20190520144103.png)
...
![image](03_SparkCoreInsight/20190521113535.png)
...
![image](03_SparkCoreInsight/20190521114511.png)
简单来说, 就是为所有的 `RDD` 有关联的分区使用同一个 `Task`, 但是就没问题了吗? 请关注红框部分
![image](03_SparkCoreInsight/20190521114717.png)
...
![image](03_SparkCoreInsight/20190521114717-20190907100039683.png)
...
![image](03_SparkCoreInsight/20190521161456.png)

如果放在集群中运行, 通过 `WebUI` 可以查看到如下 `DAG` 结构

![image](03_SparkCoreInsight/20190521161337.png)
...
![image](03_SparkCoreInsight/20190521120501.png)
...
.整体执行流程
![image](03_SparkCoreInsight/20190522015026.png)
...
![image](03_SparkCoreInsight/20190522141807.png)
...
![image](03_SparkCoreInsight/20190522160031.png)
...
![image](03_SparkCoreInsight/1d0afe0f7a86237910b974f116fc1747.png)
...
![image](03_SparkCoreInsight/97d96cbd4169753a9c44c8e3d04735d2.png)
...
![image](03_SparkCoreInsight/41b76292cc02a2e51cb086171e3420fb.png)
...
![image](03_SparkCoreInsight/7eb422ef368aec2a1e60636b0f9dfd77.png)
...
spark/dataset/access_log_sample.txt
...
class AccessLogAgg {
  ...
  def ipAgg(): Unit = {
    ...
    // 3. 取出IP, 赋予出现次数为1，使用map 算子，按空格分割，(0)表示取第一个元数，1 表示赋以1
    val ipRDD = sourceRDD.map(item => (item.split(" ")(0), 1))
